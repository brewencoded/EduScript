describe('selection', function() {
    ...
    describe('getAttrs', function() {
        it('should return map of attributes from html string', function() {
            ...
            var expectedObject = new Map();
            expectedObject.set('id', 'myId');
            expectedObject.set('class', 'myClass');
            expectedObject.set('data-attribute', '');
    ...
    describe('$()', function() {
        var $elem;
        beforeEach(function() {
            $elem = $('<div id="myId" class="myClass"></div>');
        });
        ...
        describe('Input', function() {
            it('should have different event types', function() {
                var attr = new Map();
                attr.set('class', 'myClass');
                
                var e = new $.test.JElement('div', attr);
               
                var i = new $.test.Input(attr);
        ...
        describe('on and off', function() {
            ...
            it('should add events to instance and element', function() {
                ...
                expect(div.listeners.size).toBe(1);
                div.listeners.forEach(function(listener) {
                    expect(listener.handler).toEqual(jasmine.any(Function));
                });
            });
            it('should remove events from instance and element', function() {
                ...
                div.off('click');
                expect(div.listeners.size).toBe(0);
                div.listeners.forEach(function(listener) {
            ...
            it('should add and remove multiple events at once', function() {
                ...
                expect(div.listeners.size).toBe(2);
                div.off('click');
                expect(div.listeners.size).toBe(0);
            });
